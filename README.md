# Project 4 - *Extended Twitter Client*

**Extended Twitter Client** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='http://i.imgur.com/lgZnp0X.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
